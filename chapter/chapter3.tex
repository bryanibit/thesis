...
\begin{equation}
\begin{split}
0 =(X_2-t)^T\cdot [t]_\times X_2 = (RX_1)^T\cdot [t]_\times X_2 &= X_1^TR^T[t]_\times X_2=-X_2^T[t]_\times RX_1 = -X_2EX_1 \\
0 &=-X_2EX_1 \\
\end{split}
